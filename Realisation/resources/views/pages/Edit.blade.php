...
<div style="width: 500px">
    ...
    <form action="{{url('Update')}}/{{$value->Id}}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" value="{{$value->Name_student}}" name="Name"
            ...
            <input type="number" name="Age" class="form-control" value="{{$value->Age}}" id="exampleFormControlInput1"
                placeholder="Age ">
            @error('Age')
            <div class="alert alert-danger">{{ $message }}</div>
            @enderror
            ...
            <select class="form-control" list="datalistOptions" id="exampleDataList" name="Promotion"
